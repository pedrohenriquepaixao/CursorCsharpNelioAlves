using ExercicioResolvidoEnum.Entities;
using ExercicioResolvidoEnum.Entities.Enums;
using System.Globalization;
using System;

namespace ExercicioResolvidoEnum
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine();
            Console.Write("Enter month and year calculate income (MM/YYYY)");
